...
import { View, Text, TouchableHighlight, StyleSheet, Image , ScrollView,Dimensions  } from 'react-native'
...
<Text style={styles.desc}>{article.content}</Text>
  <Text style={styles.publish}>Published At: {article.publishedAt}</Text>
     ...
     <FooterNav route={route} navigation={navigation} active="Categories"/>
</View>
  )
}
